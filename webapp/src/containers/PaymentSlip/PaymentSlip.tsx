...
export const PaymentSlip = (props: Props) => {
    ...
    return (
        ...
        >
            <StyledPaymentSlip>
                <button className="btn-modal-close" onClick={closePaymentSlipModal}>
                    X
                </button>
                <div className="grid-container">
                    <div className="grid-item">
                        ...
                        <PaymentSlipInput
                            text="Primalac"
                            key="receiver"
                            inputValue={paymentSlip?.receiver ?? ""}
                            darkMode={false}
                        />
                    </div>
                    <div className="grid-item">
                        <div className="grid-item-row">
                            ...
                            <div className="smaller-input">
                                <PaymentSlipInput
                                    text="Valuta"
                                    key="currency"
                                    inputValue={paymentSlip?.currency ?? ""}
                                    darkMode={false}
                                />
                            </div>
                        ...
                        <div className="grid-item-row">
                            <div className="smaller-input">
                                <PaymentSlipInput
                                    ...
                                    key="modelNumber"
                                    inputValue={
                                        paymentSlip?.modelNumber.toString() === undefined ||
                                        paymentSlip?.modelNumber.toString() === "0"
                                            ? ""
