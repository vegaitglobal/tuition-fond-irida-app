...
namespace TuitionFondIrida.Persistence.Mappers;
    ...
    public class BlogMapper : IBlogMapper
    {
        ...
        public BlogMapper(IAssetMapper assetMapper, IDocumentMapper documentMapper, IAuthorMapper authorMapper)
        {
        ...
        public Domain.Models.Read.Blog Create(Blog blog, string blogId)
        {
            ...
            var content = this.documentMapper.Create(blog.Content);
